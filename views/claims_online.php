                            ...
                            <ul class="nav nav-tabs stepper-nav" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="incident-tab" data-bs-toggle="tab"
                                            data-bs-target="#incident" type="button" role="tab"
                                            aria-controls="incident" aria-selected="false">
                                        <i class="bi bi-exclamation-triangle-fill me-1"></i> Incident Details
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="doc-tab" data-bs-toggle="tab"
                                            data-bs-target="#doc" type="button" role="tab"
                                            aria-controls="doc" aria-selected="false">
                            ...
                            <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="section">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            ...
                                            <div class="form-group">
                                                <label style="font-weight:500" for="policy_type" class="form-label">Policy
                                                    Type</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="claim_type" name="claim_type"
                                                       class="form-control"
                                                       placeholder="e.g., Medical, Accident, Theft">
                                            </div>
                                            <div class="form-group">
                                                <label style="font-weight:500" for="policy_number" class="form-label">Policy
                                                    Number</label>
                                            ...
                                            <div class="form-group">
                                                <label style="font-weight:500" for="claim_amount" class="form-label">Estimate
                                                    Claim
                                                    Amount
                                                    ($)</label>
                                            ...
                                            <div class="form-group">
                                                <label style="font-weight:500" for="insured_name" class="form-label">Insured
                                                    Name</label>
                                            ...
                                            <div class="form-group">
                                                <label style="font-weight:500" for="contact_number" class="form-label">Alternate
                                                    Contact
                                                    Number</label>
                                ...
                                <div class="tab-pane fade" id="incident" role="tabpanel" aria-labelledby="incident-tab">
                                    <div class="section mt-8">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div class="form-group">
                                                <label style="font-weight:500" for="incident_date" class="form-label">Incident
                                                    Date</label>
                                    ...
                                    <div class="section mt-8" id="driver_details_section">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div class="form-group">
                                                <label style="font-weight:500" for="driver_name" class="form-label">Driver
                                                    Name</label>
                                            ...
                                            <div class="form-group">
                                                <label style="font-weight:500" for="driver_contact" class="form-label">Driver
                                                    Contact</label>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="vehicle_registration_number"
                                                       ...
                                                       class="form-control" placeholder="e.g., ABC-1234">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="section mt-8" id="patient_health_details_section">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div class="form-group">
                                                <label style="font-weight:500" for="patient_name" class="form-label">Patient
                                                    Name</label>
                                            ...
                                            <div class="form-group">
                                                <label style="font-weight:500" for="patient_dob" class="form-label">Patient
                                                    Date of
                                                    Birth</label>
                                            ...
                                            <!--                                            <div class="form-group">-->
                                            <!--                                                <label style="font-weight:500" for="treatment_date" class="form-label">Treatment-->
                                            <!--                                                    Date</label>-->
                                            <!--                                                <input type="date" id="treatment_date" name="treatment_date"-->
                                            <!--                                                       class="form-control">-->
                                            <!--                                            </div>-->
                                            <div class="form-group">
                                                <label style="font-weight:500" for="hospital_name" class="form-label">Hospital
                                                    Name</label>
                                            ...
                                            <div class="form-group">
                                                <label style="font-weight:500" for="hospital_type" class="form-label">Hospital
                                                    Type</label>
                                            ...
                                            <!--                                            <div class="form-group">-->
                                            <!--                                                <label style="font-weight:500" for="attending_physician"-->
                                            <!--                                                       class="form-label">Attending-->
                                            <!--                                                    Physician</label>-->
                                            <!--                                                <input type="text" id="attending_physician"-->
                                            <!--                                                       name="attending_physician"-->
                                            <!--                                                       class="form-control"-->
                                            <!--                                                       placeholder="Name of the attending physician">-->
                                            <!--                                            </div>-->
                                            <!--                                            <div class="form-group">-->
                                            <!--                                                <label style="font-weight:500" for="benefit_schedule"-->
                                            <!--                                                       class="form-label">Benefit-->
                                            <!--                                                    Schedule</label>-->
                                            <!--                                                <textarea id="benefit_schedule" name="benefit_schedule"-->
                                            <!--                                                          class="form-control"-->
                                            <!--                                                          placeholder="Details of the benefit schedule"></textarea>-->
                                            <!--                                            </div>-->
                                            <div class="form-group md:col-span-3"><label style="font-weight:500"
                                                                                         for="diagnosis"
                                            ...
                                            <!--                                            <div class="form-group md:col-span-3"><label style="font-weight:500"-->
                                            <!--                                                                                         for="health_details"-->
                                            <!--                                                                                         class="form-label">Health-->
                                            <!--                                                    Details</label>-->
                                            <!--                                                <textarea id="health_details" name="health_details"-->
                                            <!--                                                          class="form-control"-->
                                            <!--                                                          placeholder="Any relevant health details"></textarea>-->
                                            <!--                                            </div>-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span id="claim_form_name"
                                                      class="file-name">No file chosen</span>
                                            </div>
                                            <!--                                                    <div class="form-group">-->
                                            <!--                                                        <label style="font-weight:500" for="death_certificate"-->
                                            <!--                                                               class="form-label">Death-->
                                            <!--                                                            Certificate</label>-->
                                            <!--                                                        <input type="file" id="death_certificate"-->
                                            <!--                                                               name="death_certificate"-->
                                            <!--                                                               class="form-control"-->
                                            <!--                                                               onchange="updateFileName('death_certificate')">-->
                                            <!--                                                        <span id="death_certificate_name"-->
                                            <!--                                                              class="file-name">No file chosen</span>-->
                                            <!--                                                    </div>-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4" id="auto_documents_section">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span id="vehicle_registration_card_name" class="file-name">No file chosen</span>
                                            </div>
                                            <!--                                                    <div class="form-group">-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span id="theft_complaint_letter_name"
                                                      class="file-name">No file chosen</span>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-4" id="healthcare_documents_section">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span id="discharge_summary_name"
                                                      class="file-name">No file chosen</span>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span id="medical_certificate_name"
                                                      class="file-name">No file chosen</span>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <span id="medical_expense_form_name"
                                                      class="file-name">No file chosen</span>
                                            </div>
                                            <div class="form-group">
