  ...
  <div class="container py-4">
    ...
    <form id="policyForm" class="mb-4">
      <div class="row">
        <div class="col-md-6">
          ...
          <input type="text" id="policy_number" name="policy_number" class="form-control" placeholder="Enter policy number" required>
        </div>
        <div class="col-md-6 d-flex align-items-end">
          <button type="submit" id="submitBtn" class="btn btn-primary">Find Your Policy</button>
        </div>
      </div>
    </form>
    ...
    <div id="contentCard" class="card" style="display:none;">
      <div class="card-body">
        ...
        <pre id="contentField" style="white-space: pre-wrap;"></pre>
      </div>
    </div>
  </div>
</div>
...
// Convert additional_column JSON string to formatted HTML, or fallback plain text
