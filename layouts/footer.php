...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateButtonVisibility(index) {
            ...
            // Show Submit button on last tab, hide Next
...
//alert function to show a message when the form is submitted
    document.getElementById('submitBtn').addEventListener('click', function(event) {
        event.preventDefault(); // prevent form submitting immediately
        ...
        if (confirm("Do you want to submit the form?")) {
            ...
            // User clicked Cancel, do nothing (form won't submit)
        }
    });
